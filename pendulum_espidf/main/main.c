...
#define UART_TX_GPIO_NUM GPIO_NUM_8
#define UART_RX_GPIO_NUM GPIO_NUM_9
#define BEARLY_RESET_GPIO GPIO_NUM_4


#define ACCEL_RST GPIO_NUM_10 // GPIO to reset the Accelerometer

uint8_t BEARLY_RESET = 0;
